...
export default function ShoppingCart(props) {
    ...
    return (
        <div className="h-100 m-2 d-flex flex-column align-items-center p-5 gap-3">
                                                        ...
                                                        <td colspan="1" className="ps-2">
                                                            <div className="d-flex align-items-center justify-content-center p-2">
                                                                <div className="btn btn-danger">
                                                                    <img src={deleteIcon} height={20} onClick={() => { deleteSelectedIngredient(selectedIngredient.id) }} />
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
