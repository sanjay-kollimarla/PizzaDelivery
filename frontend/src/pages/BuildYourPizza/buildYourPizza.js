...
export default function BuildYourPizza(props) {
    ...
    useEffect(() => {
        ...
        props.selectedIngredients.forEach(selectedIngredient => {
           total_cost += parseFloat(parseFloat(selectedIngredient.price).toFixed(2));
        });
            ...
            <div className="w-50 p-2">
                ...
                <div className="w-100 p-2  border border-2 border-top-0 container">
                        ...
                        <div className="row d-flex align-items-center justify-content-center">
                            <div className="col-3 btn btn-dark  border-rounded border-warning fs-4 p-2" style={{color:'orange'}} onClick={()=> {navigatePage("/shopping-cart")}}>Build Ur Pizza</div>
                        </div>
                </div>
                </div>
            </div>
